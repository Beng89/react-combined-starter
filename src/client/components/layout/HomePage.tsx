 ...
 */
class DesktopContainer extends Component<ResponsiveContainerProps> {
  state = { fixed: false }
...
class MobileContainer extends Component<ResponsiveContainerProps> {
...
const ResponsiveContainer: React.FC<ResponsiveContainerProps> = props => {
  ...
  return (
    <React.Fragment>
      <DesktopContainer {...moreProps}>{children}</DesktopContainer>
      <MobileContainer {...moreProps}>{children}</MobileContainer>
    </React.Fragment>
  )
}
...
export const HomepageLayout: React.FC<HomepageLayoutProps> = props => {
